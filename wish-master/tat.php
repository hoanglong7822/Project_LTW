...
<?php require("header.php"); ?>
	...
	<div class="products">
		<div class="container">
			...
			$sql = "SELECT * FROM `tbl_sanpham` WHERE `id_loaisanpham` IN (8) ORDER BY `sanpham_id` ASC LIMIT ".$item_per_page." OFFSET ".$offset." ";
			$totalRecords = mysqli_query($conn, "SELECT * FROM `tbl_sanpham` WHERE `id_loaisanpham` IN (8)");
