...
<?php require("header.php"); ?>
	...
	<div class="home">
		<div class="home_background parallax-window" data-parallax="scroll" data-image-src="images/quanaonu.jpg" data-speed="0.8"></div>
		<div class="container">
			<div class="row">
				<div class="col">
	...
	<div class="products">
		<div class="container">
						...
						<div class="sorting">
							<ul class="item_sorting">
								...
								<li>
									...
									<ul>
										<li class="num_sorting_btn"><a href="duoi200.php"><span>Dưới 200</span></a></li>
										<li class="num_sorting_btn"><a href="200500.php"><span>Từ 200-500</span></a><li>
										<li class="num_sorting_btn"><a href="tren500.php"><span>Trên 500</span></a></li>
									</ul>
								</li>
									</ul>
			...
			$sql = "SELECT * FROM `tbl_sanpham` WHERE `id_loaisanpham` IN (4,5,6) AND `sanpham_gia`>200000 AND `sanpham_gia`<500000 ORDER BY `sanpham_id` ASC LIMIT ".$item_per_page." OFFSET ".$offset." ";
			$totalRecords = mysqli_query($conn, "SELECT * FROM `tbl_sanpham` WHERE `id_loaisanpham` IN (4,5,6)");
