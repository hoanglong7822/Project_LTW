...
<?php require("header.php"); ?>
				...
				<div class="col">
					<div class="home_container">
						<div class="home_content">
							<div class="home_title">Khăn mặt</div>
	...
	<div class="products">
		<div class="container">
			...
			$sql = "SELECT * FROM `tbl_sanpham` WHERE `id_loaisanpham` IN (9) ORDER BY `sanpham_id` ASC LIMIT ".$item_per_page." OFFSET ".$offset." ";
			$totalRecords = mysqli_query($conn, "SELECT * FROM `tbl_sanpham` WHERE `id_loaisanpham` IN (9)");
