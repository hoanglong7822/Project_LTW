...
<?php require("header.php"); ?>
	...
	<div class="home">
		<div class="home_background parallax-window" data-parallax="scroll" data-image-src="images/quanaonam.jpg" data-speed="0.8"></div>
		<div class="container">
			<div class="row">
				<div class="col">
					<div class="home_container">
						<div class="home_content">
							<div class="home_title">Nam</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-12">
					...
					<!-- Sidebar Left -->
					<div class="current_page">Man's Fashion</div>
				</div>
				<div class="col-12">
			...
			$sql = "SELECT * FROM `tbl_sanpham` WHERE `id_loaisanpham` IN (1,2,3) ORDER BY `sanpham_id` ASC LIMIT ".$item_per_page." OFFSET ".$offset." ";
			$totalRecords = mysqli_query($conn, "SELECT * FROM `tbl_sanpham` WHERE `id_loaisanpham` IN (1,2,3)");
