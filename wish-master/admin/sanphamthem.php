...
<html lang="en">
    <head>
        ...
        <title>May | Admin | Thêm sản phẩm</title>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form method="POST" action="sanphamthuchienthem.php<?php if(isset($_GET['loaisanphamid'])) echo"?id=$loaisanphamid";?>" enctype="multipart/form-data" id="form" onsubmit="return validateForm()">
