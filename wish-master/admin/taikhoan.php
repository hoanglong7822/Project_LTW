...
<html lang="en">
    <head>
        ...
        <title>May | Admin | Tài khoản</title>
    ...
    <body class="sb-nav-fixed">
        ...
        ?>
            <?php
           echo"<pre>";
print_r($_SESSION['ten_admin']);
                $sql1="SELECT * FROM tbl_admin where email = '".$_SESSION['ten_admin']."'";
                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form method="POST" action="taikhoansua.php?id=<?php echo $row1["admin_id"]; ?>" enctype="multipart/form-data">
                                            ...
                                            <div class="form-floating mb-3">
                                                <input readonly class="form-control" id="txtMatkhau" type="password" placeholder="Mật khẩu" name="txtMatkhau" value ="<?php echo $row1["password"];?>"/>
