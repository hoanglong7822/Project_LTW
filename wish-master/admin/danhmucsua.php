...
<html lang="en">
    <head>
        ...
        <title>May | Admin | Cập nhập danh mục</title>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form method="POST" action="danhmucthuchiensua.php" enctype="multipart/form-data" id="formsua" onsubmit="return validateForm()">
                                            ...
                                            <div class="mt-4 mb-0">
                                                <input type="hidden" name="txtID" value ="<?php echo $row1["id_loaisanpham"];?>">
