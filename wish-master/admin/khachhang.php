...
<html lang="en">
    <head>
        ...
        <title>May | Admin | Danh sách khách hàng</title>
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    ;?>
                                        <tr>
                                            ...
                                            <td><a class="btn btn-danger" href="khachhangxoa.php?id=<?php echo $row["khachhang_id"]; ?>" onclick="return confirm('Bạn có muốn xoá?')">Xoá</a></td>
                                        </tr>
                                    <?php
                                        }
                                    ;?>
