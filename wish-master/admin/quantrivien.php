...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        ...
        ?>
            ...
            <?php
                include("./config.php");
                $sql="SELECT * FROM tbl_admin where email = '".$_SESSION['ten_admin']."'";
                $kq = mysqli_query($ket_noi, $sql);
                $rowql = mysqli_fetch_array($kq);
                if ($rowql['chuc_vu']=='quan_ly') {
                    $check=1;
                }
                else
                    $check=0;
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                Danh sách quản trị viên | <a href="<?php if($check==1) echo "quantrivienthem.php" ;?>" onclick="<?php if($check==0) echo" return alert('Bạn không có quyền thêm mới quản trị viên')";?>">Thêm mới</a>
                            </div>
                            <div class="card-body">
                                    ...
                                    ;?>
                                        <tr>
                                            ...
                                            <?php
                                                ...
                                                {
                                            ;?>
                                                <td><a  class="btn btn-success" href="quantriviensua.php?id=<?php echo $row1["admin_id"]; ?>">Sửa</a></td>
                                            <?php }
                                                else
                                                {
                                            ;?>
                                            ...
                                            <?php
                                                ...
                                                {
                                            ;?>
                                                <td><a  class="btn btn-danger" href="quantrivienxoa.php?id=<?php echo $row1["admin_id"]; ?>" onclick="return confirm('Bạn có muốn xoá?')">Xoá</a></td>
                                            <?php }
                                                else
                                                {
                                            ;?>
